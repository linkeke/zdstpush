/*package cn.zdst.fireAlarm.usercenter.test;
...
import cn.zdst.fireAlarm.usercenter.server.Application;
...
public class WebsocketTest {
 ...
 if (failure.get() != null) {
 throw new AssertionError("Zzzzzzzzzzzzzzzzzza", failure.get());
 }
 }
 else {
 logger.debug("Greeting not received");
 }
